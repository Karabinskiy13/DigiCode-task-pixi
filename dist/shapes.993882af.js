...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"components/shapes.js":[function(require,module,exports) {
...
var shapesTypes = ["Circle", "Ellipse", "Triangle", "Rectangles", "Hexagon"];
...
var Shape = /*#__PURE__*/function (_PIXI$Graphics) {
  ...
  _createClass(Shape, [{
    ...
    value: function Hexagon() {
      ...
      hexagon.drawPolygon([-hexagonRadius, 0, -hexagonRadius / 2, hexagonHeight / 2, hexagonRadius / 2, hexagonHeight / 2, hexagonRadius, 0, hexagonRadius / 2, -hexagonHeight / 2, -hexagonRadius / 2, -hexagonHeight / 2]);
      hexagon.endFill();
      return hexagon;
    }
  }, {
    key: "randomShapeName",
    value: function randomShapeName() {
      return shapesTypes[Math.floor(Math.random() * shapesTypes.length)];
    }
  }, {
    key: "generateShape",
    value: function generateShape(name) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "1371" + '/');
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","components/shapes.js"], null)
//# sourceMappingURL=/shapes.993882af.js.map